...
internal abstract class JsonDynamicAccessor : DynamicObject
{
    ...
    public override bool TryUnaryOperation(UnaryOperationBinder binder, out object? result)
    {
        ...
        {
            Linq.Expressions.ExpressionType.IsTrue => Result(true, out result),
            Linq.Expressions.ExpressionType.IsFalse => Result(false, out result),
            Linq.Expressions.ExpressionType.Not => Result(false, out result),
